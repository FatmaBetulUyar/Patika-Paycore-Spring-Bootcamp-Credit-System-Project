...
import com.paycore.creditsystem.exception.handler.GenericExceptionHandler;
import com.paycore.creditsystem.model.CreditApplication;
import com.paycore.creditsystem.model.Customer;
import com.paycore.creditsystem.service.iml.CreditApplicationServiceImpl;
...
class CreditApplicationControllerTest {
    ...
    private List<CreditApplication> getTestCreditApplications(){
        ...
        creditApplications.add(new CreditApplication(1,true,1000.0F,new Customer(1,"12345678987","Betul","UYAR",10000.0F,"05708975647",null,null)));
        creditApplications.add(new CreditApplication(2,false,0.0F,new Customer(2,"12345678987","Eslem","UYAR",8000.0F,"05708975634",null,null)));
