...
import com.paycore.creditsystem.service.iml.CustomerServiceImpl;
...
class CustomerControllerTest {
    ...
    void updateCustomer() throws Exception{
        List<Customer> expectedCustomers=getTestCustomers();
        Customer expectedCustomer=new Customer(1,"12345678987","Betul","UYAR",9000.0F,"05703838323",null,null);
        Customer updatedCustomer=new Customer(1,"12345678987","Fatma","UYAR",9000.0F,"05703838323",null,null);
    ...
    private List<Customer> getTestCustomers(){
        ...
        customers.add(new Customer(1,"12345678956","Betul","UYAR",5000.0F,"05704567870",
